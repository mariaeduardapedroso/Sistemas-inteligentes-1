...
model.append([abs(float(components[0])), float(components[2]), str(components[3])])
...
while cv.waitKey(1) < 0:
    ...
    # Exibe mensagem com a predicao
    cv.putText(frame, "Predicao: " + str(knn_algorithm.getKNN([angle,distNH], model, 3)), (500, 20), cv.FONT_HERSHEY_SIMPLEX, 0.5, (1, 1, 1))
