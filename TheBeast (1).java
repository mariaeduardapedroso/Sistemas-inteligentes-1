...
public class TheBeast extends AdvancedRobot {
	...
	public void applyCassadaCelwagem() {
		// define do inimigo (mais próximo)
		// cria a trajetória em zig zag
		// atira dutrante a trajetória
		// aumenta a força do tiro conforma distância
		ahead(20);
	}
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		switch (this.state) {
			...
			// Atualize a lista de robôs escaneados
					scannedRobots.add(e);
					
					// Limpa a lista para manter somente os robôs recentemente escaneados
					if (scannedRobots.size() > 10) {
						scannedRobots.remove(0);
					}
				break;
