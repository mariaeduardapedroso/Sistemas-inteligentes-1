...
public class TheBeast extends AdvancedRobot {
    ...
    public void run() {
        ...
        setColors(new Color(165, 42, 42),Color.black,Color.black); // body,gun,radar
            ...
            if (getOthers() == 1) {
                ...
                if (getEnergy() > 25) {
                    if (getEnergy() < 70) {
                        ...
                        // combate com rastreamento oscilatorio
                        this.state = 3;
                        turnGunRight(10);
                    }
                } else {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        switch (this.state) {
            case 1: // applyVemTranquilo
                ...
                out.println(
                        "Theta: " + theta + "Gun Heading: " + getGunHeading() + "Radar heading: " + getRadarHeading());
    ...
    // Funcao caso o robo skipe um turno
